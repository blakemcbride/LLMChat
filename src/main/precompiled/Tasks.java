...
public class Tasks {
     ...
     */
    private static int portBase = 8200;
    ...
    private static ForeignDependencies buildForeignDependencies() {
        ...
        // Database drivers: this application uses SQLite only (see sqlite-jdbc below).
        // The PostgreSQL, Oracle (ojdbc), MySQL, and SQL Server (mssql) JDBC drivers
        // were removed because nothing in this application references them.
        ...
        // JLine — terminal line editing & history for the LLMChat CLI (single bundle jar)
        dep.add(LIBS, "https://repo1.maven.org/maven2/org/jline/jline/3.26.3/jline-3.26.3.jar");
